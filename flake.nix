	...
	outputs = { self, nixpkgs, ... }@inputs:
		...
		let
			...
			hosts = [
				...
				{ puterType = "laptop"; hostname = "thinkputer"; stateVersion = "26.05"; gpuDriver = "integrated"; monitor = "1920x1080@60"; scale = "1"; uuid = "229dd9c7-4b5a-4176-a5a8-c128654dfbb9"; resumeOffset = "533670"; }
			];
